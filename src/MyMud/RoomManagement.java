...
public class RoomManagement {
	...
	public static void  setRoomsdrectoin(Room source,CommonContent.DIRECTION d,Room next) {
		source.setRoom(d, next);
		CommonContent.DIRECTION rd=StaticFunctions.getRDirection(d);
		next.setRoom(rd, source);
	}
